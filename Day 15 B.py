...
#This version lets you randomise initial conditions- more fun that doing it by hand
#The preset conditions give rise to quite pretty dynamics
...
# Randomises inputs and simulates
def randomise():

    y0p = [np.random.normal(0,4),np.random.normal(0,2),np.random.normal(0,4),np.random.normal(0,2),np.random.normal(0,4),np.random.normal(0,2),np.random.normal(0,4),np.random.normal(0,2),np.random.normal(0,4),np.random.normal(0,2),np.random.normal(0,4),np.random.normal(0,2)]
    s1_0.delete(0,'end')
...
randomise_button = tk.Button(root, text="Randomise Initial Conditions", command=lambda: randomise(), font=custom_font, fg="white", bg="#292929")
randomise_button.grid(row=9, column=1, padx=10, pady=10)
root.mainloop()