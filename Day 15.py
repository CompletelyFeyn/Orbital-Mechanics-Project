...
def gather():
    ...
    initial_position2 = s3_0.get()
    initial_positions2 = initial_position2.split(",")
    x3_0 = float(initial_positions2[0])
    y3_0 = float(initial_positions2[1])
...
def newt(t, y):
    ...
    dv_x1dt = -10 * M2 * (x2-x1) / (r_12 ** 3) +10 * M3 * (x3-x1)/ (r_13 ** 3)
    dv_y1dt = -10 * M2 *(y2- y1) / (r_12 ** 3) +10 * M3 * (y3-y1)/ (r_13 ** 3)
    dv_x2dt = -10 * M1 * (x1-x2) / (r_12 ** 3)+10 * M3 * (x3-x2)/ (r_23 ** 3)
    dv_y2dt = -10 * M1 * (y1-y2) / (r_12 ** 3)+10 * M3 * (y3-y2)/ (r_23 ** 3)
    dv_x3dt = -10 * M1 * (x3-x1) / (r_13 ** 3)+10 * M2 * (x2-x3)/ (r_23 ** 3)
    dv_y3dt = -10 * M1 * (y3 - y1) / (r_13 ** 3) +10 * M2 * (y2 - y3) / (r_23 ** 3)
...
s3_0.insert(0,str(y0p[4]) + "," + str(y0p[6]))
